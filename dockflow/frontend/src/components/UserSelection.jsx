        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white font-medium py-6 px-4 rounded-lg transition-colors flex flex-col items-center justify-center"
            >
            ...
            <button
              ...
              className="bg-green-600 hover:bg-green-700 text-white font-medium py-6 px-4 rounded-lg transition-colors flex flex-col items-center justify-center"
            >
              <svg className="w-8 h-8 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
