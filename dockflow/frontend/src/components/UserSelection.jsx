        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              ...
              className="bg-blue-100 hover:bg-blue-200 text-blue-800 font-medium py-4 px-6 rounded-lg transition-colors flex items-center justify-center gap-3 w-full sm:w-auto"
            >
              ...
              <span className="text-lg font-semibold">管理者</span>
            </button>
            <button
              onClick={() => handleDirectNavigation('vendor')}
              className="bg-green-100 hover:bg-green-200 text-green-800 font-medium py-4 px-6 rounded-lg transition-colors flex items-center justify-center gap-3 w-full sm:w-auto"
            >
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 11V7a4 4 0 00-8 0v4M5 9h14L1 12H4L5 9z" />
              </svg>
              <span className="text-lg font-semibold">納入業者</span>
            </button>
          </div>
        </div>
